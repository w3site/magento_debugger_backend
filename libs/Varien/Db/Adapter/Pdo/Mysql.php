...
class Varien_Db_Adapter_Pdo_Mysql extends Zend_Db_Adapter_Pdo_Mysql implements Varien_Db_Adapter_Interface
{
     ...
     * @var float
     */
    static protected $_logQueryTime        = 0.05;
     ...
     * @var bool
     */
    static protected $_logAllQueries       = false;
    ...
    public static function setLogCallStack($value = true){
        self::$_logCallStack = $value;
    }
    ...
    protected function _debugStat($type, $sql, $bind = array(), $result = null)
    {
        ...
        if (!static::$_logAllQueries && $time < static::$_logQueryTime) {
            return $this;
        }
        switch ($type) {
