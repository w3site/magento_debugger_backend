<?php
/**
 * Remade by Tereta Alexander (www.w3site.org)
...
class Mage_Core_Model_Email_Template extends Mage_Core_Model_Template
{
    ...
    protected $_mailDebuggerInfo = null;
    ...
    {
        $this->_mailDebuggerInfo = new Varien_Object();
    ...
    {
        $this->_mailDebuggerInfo->setArea(Mage::getDesign()->getArea());
        $this->_mailDebuggerInfo->setTemplateId($templateId);
        ...
        $this->_mailDebuggerInfo->setTemplateFile($data['file']);
